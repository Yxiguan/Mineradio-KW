...
var SEARCH_HISTORY_MODES = ['song', 'netease', 'qq', 'kugou', 'kw', 'qishui', 'spotify', 'podcast'];
...
function setSearchMode(mode) {
  mode = (mode === 'podcast' || mode === 'netease' || mode === 'qq' || mode === 'kugou' || mode === 'kw' || mode === 'qishui' || mode === 'spotify') ? mode : 'song';
...
var MUSIC_SEARCH_PROVIDER_ORDER = ['netease', 'qq', 'kugou', 'kw', 'qishui', 'spotify'];
...
function searchModeProvider(mode) {
  return mode === 'netease' || mode === 'qq' || mode === 'kugou' || mode === 'kw' || mode === 'qishui' || mode === 'spotify' ? mode : '';
}
